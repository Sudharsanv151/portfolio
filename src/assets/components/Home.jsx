...
const Home = () => {
    return (
        ...
        >
            <h1 className="text-white pb-1 text-6xl font-home-font">
                Hi, <br /> I'm <span className="text-red-500">Sudharsan V</span>
                <p className="text-2xl font-para-font">Learning Full Stack Developer</p>
            </h1>

            <div className="flex flex-col mr-32 p-4">
                <div class="flex items-center gap-4">
                    <a href="https://www.instagram.com/sudhars_37/">
                        <div class="social-button">
                            <button class="relative w-12 h-12 rounded-full group">
                                <div
                                    class="floater w-full h-full absolute top-0 left-0 bg-gradient-to-r from-[#833ab4] via-[#fd1d1d] to-[#fcb045] rounded-full duration-300 group-hover:-top-8 group-hover:shadow-2xl"
                                ></div>
                                <div
                    ...
                    <div class="social-button">
                        <a href="https://linkedin.com/in/sudharsanv151">
                            <button class="relative w-12 h-12 rounded-full group">
                                <div
                    ...
                    <div class="social-button">
                        <a href="mailto:sudharsan152005@gmail.com">
                            <button class="relative w-12 h-12 rounded-full group">
                                <div
                                    class="floater w-full h-full absolute top-0 left-0 bg-orange-400 rounded-full duration-300 group-hover:-top-8 group-hover:shadow-2xl"
                                ></div>
                                <div
